    ...
    render() {
        ...
        return (
            <div id="wrapper" className="content">
                <div className="container navbar-inverse">
                        ...
                        <nav className="navbar navbar-default" role="navigation">
                            <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul className="nav navbar-nav">
                                    <li>
                                    <img src={mytips} alt="Image" />
                                    </li>
                                </ul>
                                <ul className="nav navbar-nav">
                                    <li className="active"><a onClick={(e) => { e.preventDefault(); history.push('/'); }}>Tips</a></li>
                                    <li><a href="" onClick={(e) => { e.preventDefault(); history.push('/category'); }}>Category</a></li>
                                </ul>
                                <ul className="nav navbar-nav pull-right">
                                    ...
                                    {sessionStorage.login ?
                                        ...
                                        <li className="btn btn-social btn-facebook" onClick={() => this.facebookLogin()}>
